    ...
    function ensureDom() {
	      ...
	      toast.textContent = "Saved";
	        ...
	        <div class="mk-magic-title">
	          <div>Auth <span id="mkMagicStatus" class="mk-magic-pill" style="margin-left:8px">Signed out</span></div>
              ...
              <div id="mkMagicOtpInline" class="mk-magic-section" style="display:none;margin-top:10px">
		        ...
		        <div id="mkMagicWalletSection" class="mk-magic-section" style="margin-top:12px">
	      ...
	      chainSelect?.addEventListener("change", (e) => {
	        ...
	        saveToStorage();
		      ...
		      el = {
		        ...
		        toast,
		        panel,
		        walletSection: panel.querySelector("#mkMagicWalletSection"),
      ...
      try {
        ...
        render();
			    ...
			    function render() {
				      ...
				      const walletDisabled = global.__MAGIC_WALLET_DISABLED === true;
				      try {
				        el.setStatusImg?.(signedIn);
				      } catch {
				        // ignore
				      }
				      if (el.walletSection && el.walletSection.style) {
				        el.walletSection.style.display = walletDisabled ? "none" : "block";
				      }
	    ...
	    function loadScript(src) {
	      ...
	      try {
	        ...
	        if (typeof json.walletDisabled === "boolean") {
	          global.__MAGIC_WALLET_DISABLED = json.walletDisabled;
	        }
    ...
    function showSavedToast(text = "Saved", durationMs = 2000) {
      ...
      toastTimer = setTimeout(() => {
	    ...
	    async function getOrCreateServerWallet() {
	      ensureDom();
	      setError("");
	      if (global.__MAGIC_WALLET_DISABLED === true) {
	        setError("Wallet is disabled by server configuration.");
	        render();
	        return;
	      }
	      state.loading = true;
