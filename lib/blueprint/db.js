...
const createMailboxMessage = ({
  ...
  const row = {
    ...
    mailboxEmail: String(mailboxEmail || "").trim().toLowerCase(),
...
const listMailboxMessages = ({ workspaceId, connectorId, connectionId, mailboxEmail, planId } = {}) => {
  ...
  const email = String(mailboxEmail || "").trim().toLowerCase();
...
const getLatestMailboxMessage = ({ workspaceId, connectorId, connectionId, mailboxEmail, planId } = {}) => {
  const rows = listMailboxMessages({
    workspaceId,
    connectorId,
    connectionId,
    mailboxEmail,
